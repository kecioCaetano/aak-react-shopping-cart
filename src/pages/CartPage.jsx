...
function CartPage() {
    ...
    useEffect(() => { document.title = 'Your Shopping Cart | Savant Eyewear Store' }, [])
            ...
            {cart.length >= 1
                ...
                (
                    <>
                        ...
                        <form action="" className="cart__form" onSubmit={checkOutProduct}>
                            <table className="cart__table">
                                <thead>
                                    <tr className="cart-item__row cart-item__header-row">
                                        <th scope="col" className="cart-item__header-cell">Item</th>
                                        <th scope="col" className="cart-item__header-cell">Price</th>
                                        <th scope="col" className="cart-item__header-cell">Quantity</th>
                                        <th scope="col" className="cart-item__header-cell">Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {
                                        cart.map((item, index) => {
                                            ...
                                            return (
                                                <CartRow key={`${item.itemId}--product-in-cart`}
